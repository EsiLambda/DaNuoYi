...
def quick_run(tasks=None, classifier_name='lstm', waf='mod_security', seed=None, rnd_select=False, no_mutation=False):
    ...
    arguments.add_argument("--evolve_round", default=5, help="Maximum number of fuzzing rounds")
    arguments.add_argument("--pop_size", default=20, help="Fuzzing step size for each round (parallel fuzzing steps)")
